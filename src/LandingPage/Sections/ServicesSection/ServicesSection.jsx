...
const ServicesSection = () => {
  return (
   ...
   <div className={style.container}>
     <h4 className={style.services__heading}>
     ...
     <div className={style.services__items}>
         ...
         <div className={style.services__icon}>
           <svg width="80px" height="80px" viewBox="0 0 24 24" fill="none">
             <path
               ...
               stroke="#cda05f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
           </svg>
         </div>
         <div className={style.services__content}>
           <h5 className={style.services__h}>
             Банкротство
           </h5>
           <div className={style.services__text}>
             Юридический процесс, в ходе которого списываются все долги лицам, которые не в состоянии расплатиться
             со своими кредиторами. Это способ - начать все сначала, ликвидировав все долговые обязательства
       ...
       <div className={style.services__item}>
         ...
         <div className={style.services__content}>
           ...
           <div className={style.services__text}>
             Правовой анализ перспектив дела, досудебный порядок урегулирования спорных взаимоотношений, подготовка
             документов, подача в суд, представление интересов клиента на всех стадиях судебного процесса, работа
             по обеспечению исполнения судебного решения
           </div>
       ...
       <div className={style.services__item}>
         ...
         <div className={style.services__content}>
           ...
           <div className={style.services__text}>
             Вопросы признания права собственности на объекты недвижимости, исправление реестровых ошибок и многие
             другие вопросы в сфере земельных правоотношений будут решены нашими квалифицированными юристами.
       ...
       <div className={style.services__item}>
         ...
         <div className={style.services__content}>
           ...
           <div className={style.services__text}>
             Проверка объекта перед покупкой, обеспечение безопасности Вашей сделки, оказание содействия в поиске
             объектов недвижимости для покупки/аренды, в том числе путем участия в торгах, продажа недвижимости,
             сопровождение переговоров, сделок с недвижимым имуществом
           </div>
       ...
       <div className={style.services__item}>
         ...
         <div className={style.services__content}>
           ...
           <div className={style.services__text}>
             Услуга, которая позволяет владельцам недвижимости установить кадастровую стоимость объектов
             недвижимости равной их рыночной стоимости с целью снижения налоговой нагрузки, возврат излишне
             уплаченного налога
           </div>
       ...
       <div className={style.services__item}>
         ...
         <div className={style.services__content}>
           ...
           <div className={style.services__text}>
             Вопросы по включению имущества в состав наследственной массы в судебном порядке, исправление ошибок в
             завещании и иные споры в области наследственных правоотношений
           </div>
